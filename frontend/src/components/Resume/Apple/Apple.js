	...
	render() {
		return(
			<div> 
				<h2>Apple</h2>
				<p>
					Collected, analyzed, sanitized and ensured QA/QC of large data sets and compiled content
					from disparate sources, including databases, documents and websites for use of developers
					resulting in a number of new options and features
				</p>
				<p>
					Constructed precise map data using proprietary GIS software and published regularly ad
					hoc reports for developers as needed for mini experimental projects outside project scope					
				</p>
				<h2>More details</h2>
				<p>
					After my time in the financial industry, I felt like I wanted to do something more in tech, which led me to my next position at Apple. I was once again a contractor, employed by Apex Systems. We spent 3 months of the 1 year contract focused on training and going over thousands of pages of specifications and learning to use their proprietary software. They had high expectations and standards of what they wanted and my job was to effectively act as QA. Without breaking NDA, I shifted through massive amounts of data validating, cleansing, capturing and updating data sets. 
				</p>
				<p>
					As with any large project, scope changes over time. As such rules and specifications we would be adhering to would suddenly change and we’d have to adapt and apply the new implementation on current and past datasets. We would also get small side projects too for experimental builds. Those usually consisted of capturing extra data or creating reports and documentations of observations based on the data and reporting back. Those projects would usually have short deadlines and high priority..
				</p>
				<p>
