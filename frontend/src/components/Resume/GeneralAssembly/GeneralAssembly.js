...
class GeneralAssembly extends Component {
	render() {
		return(
			<div> 
				<h2>GeneralAssembly</h2>
				<p>
					After my time in the financial industry, I felt like I wanted to do something more in tech, which led me to my next position at GeneralAssembly. I was once again a contractor, employed by Apex Systems. We spent 3 months of the 1 year contract focused on training and going over thousands of pages of specifications and learning to use their proprietary software. They had high expectations and standards of what they wanted and my job was to effectively act as QA. Without breaking NDA, I shifted through massive amounts of data validating, cleansing, capturing and updating data sets. 
					...
					I had several talks with managers and was set up to be converted to full time at GeneralAssembly. However, towards the end of the contract, upper management decided to kill the project and everyone would be allowed to work until the end of their contract. 
				</p>
				<p>
					My first job was at Silicon Valley Bank as a Enhance Due Diligence(EDD)/Know Your Client(KYC) Analyst. My days consis 
				</p>
			</div>
		)	
	}
